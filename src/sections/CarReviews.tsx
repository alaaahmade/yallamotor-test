    ...
    <section className="py-8 px-6 md:px-35">
      <div className="mx-auto">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-4 gap-4 py-2">
          ...
          <button className="self-start md:self-auto text-blue-700 border border-blue-700 hover:text-blue-800 hover:border-blue-800 font-bold py-1 px-4 rounded" aria-label="View all car reviews">View All</button>
        </div>
        {reviews.length > 0 ? (
